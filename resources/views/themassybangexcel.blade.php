    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Nhập ASSY bằng excel</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                <form action="/docexcelassy" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <div class="form-group" style="height:90px">
                                <a href="/mauexcelassy" class="btn btn-bg bg-success">Tải file</a>
                            </div>
            ...
            <div class="card card-success" id="table-data" style="display: none;">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="POST" action="themassyexcel">
                        @csrf
                             ...
                             if(!empty($results)){      
                                ...
                                @foreach ($results[0] as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td><input style="background-color: transparent; border: none; outline: none;"
                                                type="text" name="col5[]" value="{{ $data[4] }}"></td>
