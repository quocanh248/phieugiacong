...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Nâng cấp Ver ASSY</h1>
                </div>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/nangcapverassy" method="GET">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="version" id="version" list="version12"
                                                value="{{ $version[0]->tenversion }}" class="form-control" autocomplete="off"
                                                required>
                                ...
                                @foreach ($version as $data)
                                    <tr>
                                        <td><input style="background-color: transparent; border: none; outline: none;"
                                            type="text" name="colassy[]" value="{{ $data->assy }}"></td>
                                        <td><input style="background-color: transparent; border: none; outline: none;"
