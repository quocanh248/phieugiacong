...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Copy Model ASSY</h1>
                </div>
            </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="/copymodelassy" method="GET">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="model" id="model" list="cities"
                                                value="{{ $model[0]->tenmodel }}" class="form-control" autocomplete="off"
                                                required>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="tenversion" id="tenversion" list="version"
                                                value="{{ $model[0]->tenversion }}" class="form-control" autocomplete="off"
                                                required>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="input1">Paste </label>
                                            <br>
                                            <button type="submit" name="nangcap" value="{{ $model[0]->mamodel }}"
                                                class="btn btn-bg bg-primary"><i class="fa-regular fa-paste"></i></button>
                                        </div>
                                ...
                                @foreach ($model as $data)
                                    <tr>
                                        <td><input style="background-color: transparent; border: none; outline: none;"
                                            type="text" name="col2[]" value="{{ $data->assy }}"></td>
                                        <td><input style="background-color: transparent; border: none; outline: none;"
                                                type="text" name="col3[]" value="{{ $data->tenthietke }}"></td>
                                        <td><input style="background-color: transparent; border: none; outline: none;"
                                                readonly type="text" name="col4[]" value="{{ $data->tenmau }}"></td>
                                        {{-- <td><input style="background-color: transparent; border: none; outline: none;"
