                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <br>
                                            <span class="btn btn-bg bg-danger">
                                                <a onclick="xoaver()">
                                                    Xóa
                                                </a>
                                            </span>
                        ...
                        <tbody>
                            ...
                            @endphp
                                <tr>
                                    ...
                                    <td>{{ $data->tenmau }}</td>
                                    <td><div style=" height: 30px;  width: 30px; border-radius: 50%; border: 1px solid black; background-color:{{$data->mamau}}"></div></td>
                                    ...
                                    <td>
                                        <span class="btn btn-sm bg-primary">
                                            <a
                                                href="/capnhatmodelassy/{{ $data->mamodel }}/{{ $data->maversion }}/{{ $data->mathietke }}">
                                                Sửa
                                            </a>
                                        </span>
                                        <span class="btn btn-sm bg-danger">
                                            <a onclick="xoaassy({{ $data->mathietke }})">
                                                Xóa
                                            </a>
                                        </span>
                                    </td>
